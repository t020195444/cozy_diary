...
import 'Page/Edit_Personal.dart';
...
class _CustomScrollWidgetState extends State<CustomScrollWidget>
  ...
  ValueNotifier<double> _dynamicTotalHeight = ValueNotifier<double>(0);
  dynamic image;
  ...
  _getTotalHeight(_) {
    ...
    _dynamicTotalHeight.value = _dynamicTotalHeight.value + kToolbarHeight;
    print(_dynamicTotalHeight.value);
    return _dynamicTotalHeight.value;
  }
    ...
    return ValueListenableBuilder(
      builder: (context, value, child) {
        return SliverAppBar(
          ...
          expandedHeight: _dynamicTotalHeight.value,
          floating: false,
          pinned: true,
          snap: false,
      ...
      valueListenable: _dynamicTotalHeight,
    );
  }
