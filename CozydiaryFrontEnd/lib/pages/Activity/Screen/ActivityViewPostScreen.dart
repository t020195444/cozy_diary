...
class ActivityViewPostScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    getPostController.likes.value =
        ActivityPostService.activityDetailList['likes'];
                ...
                Column(
                  children: [
                    ...
                    ActivityPostService.activityDetailList['holder'] ==
                        ...
                        : Obx(
                            () => getPostController.isParticipant.value == true
                                ? Align(
                                    alignment: Alignment.center,
                                    child: Padding(
                              ...
                              Obx(
                                () => Column(
                                  children: [
                                    InkWell(
                                      onTap: () async {
                                        await getPostController.checkLike(
                                            Hive.box("UidAndState").get("uid"));
                                      },
                                      child: Icon(
                                    ...
                                    Text(
                                      getPostController.likes.value.toString(),
                                      style: TextStyle(fontSize: 15),
                                    ),
                                  ],
                                ),
